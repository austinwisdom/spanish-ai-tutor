    ...
    return (
        ...
        <ul className='w-1/3 mx-20 mt-10 h-10  flex flex-row justify-center rounded-2xl border-2'>
          ...
          <li className='list-none px-4 self-center'>
            <NavLink to={"/"}  className={({ isActive }) => isActive ? 'text-yellow-300 cursor-pointer' :  'text-black hover:text-red-700 cursor-pointer'}><button>
            Home
            </button>
          ...
          <li className='list-none px-4 self-center'>
            <NavLink to={"/about"} className={({ isActive }) => isActive ? 'text-yellow-300 cursor-pointer' :  'text-black hover:text-red-700 cursor-pointer'}>Lessons
              {/* <span className="absolute inset-x-1 -bottom-px h-px w-full bg-gradient-to-r from red-500/0 via-red-500/40 to-red-500/0 dark:from-red-400/0 dark:via-red-400/40 dark:to-red-400/0"></span> */}
            </NavLink>
          </li>
          <li className='list-none px-4 self-center'>
            <NavLink to={"/projects"} className={({ isActive }) => isActive ? 'text-yellow-300 cursor-pointer' :  'text-black hover:text-red-700 cursor-pointer'}>Conversation
              {/* <span className="absolute inset-x-1 -bottom-px h-px w-full bg-gradient-to-r from red-500/0 via-red-500/40 to-red-500/0 dark:from-red-400/0 dark:via-red-400/40 dark:to-red-400/0"></span> */}
            </NavLink>
          </li>
        </ul>
